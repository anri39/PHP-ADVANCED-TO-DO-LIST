...
$sql = "
  SELECT logs.id, users.username, logs.action, logs.created_at
  FROM logs
...
<style>
  * {
  ...
  .log-action:contains("created") {
    background: #eaffea;
    color: #27ae60;
  }

  .log-action:contains("updated") {
    background: #fff5e0;
    color: #e67e22;
  }
...
<div class="sidebar" id="sidebar">
  ...
  <a href="admin.php" class="mar">Users</a>
